...
<video autoplay muted loop controls style={{ width: "100%", height: "auto" }}>
  <source src="/img/chapter3/figure3.1.mov" type="video/quicktime" />
...
<video autoplay muted loop controls style={{ width: "100%", height: "auto" }}>
  <source src="/img/chapter3/figure3.4.mov" type="video/quicktime" />
...
<video autoplay muted loop controls style={{ width: "100%", height: "auto" }}>
  <source src="/img/chapter3/figure3.5.mov" type="video/quicktime" />
...
<video autoplay muted loop controls style={{ width: "100%", height: "auto" }}>
  <source src="/img/chapter3/figure3.6.mov" type="video/quicktime" />
...
<video autoplay muted loop controls style={{ width: "100%", height: "auto" }}>
  <source src="/img/chapter3/figure3.8.mov" type="video/quicktime" />
